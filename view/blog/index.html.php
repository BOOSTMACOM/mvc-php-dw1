...
<p class="art"><a class="text-info font-wheight-light" href="/?controller=blog&action=article&id=<?= $article['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-90deg-right" viewBox="0 0 16 16">
